  ...
  <div class="workspace">
    ...
    <main>
      ...
      <section id="roadmap" class="roadmap-section content-pad">
        <div class="roadmap-intro"><div><div class="eyebrow">WHERE WE'RE HEADING</div><h2>A more connected future.</h2></div><a class="quiet-link" href="https://docs.robinhood.com/chain/" target="_blank" rel="noreferrer">Built around Robinhood Chain <ExternalLink :size="15" /></a></div>
      ...
      <footer class="site-footer content-pad">
        ...
        <div class="footer-bottom"><span>© 2026 {{ brand.name }}</span><p>Illustrative data. Not financial advice. RWA access depends on eligibility and jurisdiction.</p><a href="https://robinhoodchain.blockscout.com" target="_blank" rel="noreferrer">Block explorer <ExternalLink :size="13" /></a></div>
      </footer>
    </main>
  </div>
